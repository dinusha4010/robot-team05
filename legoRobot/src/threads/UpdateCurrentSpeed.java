...
public class UpdateCurrentSpeed {

    public static void updateRunValue(int LeftMotorSpeed, int RightMotorSpeed) {
        try {
            // Create the URL object with the endpoint
            URL url = new URL("http://192.168.101.122:8080/rest/legoservice/setcurrentspeed");
            ...
            // Create JSON payload
            String payload =  "{\"leftMotorSpeed\": " + LeftMotorSpeed + ", \"rightMotorSpeed\": " + RightMotorSpeed + "}";
